...
class Message {
    ...
    public function getMostRecentUser(){//get most recently user related to self
    ...
    public function getMessages($otherUser){
        ...
        if($get_messages_query != false) {
            while ($row = mysqli_fetch_array($get_messages_query)) {
                $user_to = $row['user_to'];
                $user_from = $row['user_from'];
                $body = $row['body'];
                //green:self message(right). red:other message(left)
    ...
    public function getConvos(){
        ...
        while($row = mysqli_fetch_array($query)) {
            //push the other user not loggedIn user
        ...
        foreach ($convos as $username) {
            ...
            $split = str_split($latest_message_details[1], 12);//split sentence every 12 letters
            $split = $split[0] .$dots;
